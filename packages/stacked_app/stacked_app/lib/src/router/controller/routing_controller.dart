...
import 'package:stacked_app/src/matcher/route_matcher.dart';
import 'package:stacked_app/src/navigation_failure.dart';
import 'package:stacked_app/src/route/page_route_info.dart';
import 'package:stacked_app/src/route/route_data.dart';
import 'package:stacked_app/src/route/route_def.dart';
...
abstract class RoutingController {
  ...
  List<StackedRoutePage> get stack;
...
class RouterNode extends ChangeNotifier implements RouteNode, RoutingController {
  ...
  @override
  List<StackedRoutePage> get stack => List.unmodifiable(_children.values.map((e) => e.page));
  ...
  RouteNode _createRouteNode(PageRouteInfo route, {RouteConfig config}) {
    ...
    StackedRoutePage page = pageBuilder(routeData, config);
    if (config.isSubTree) {
      return RouterNode(
        parent: this,
        key: config.key,
  ...
  void removeEntry(StackedRoutePage page) {
