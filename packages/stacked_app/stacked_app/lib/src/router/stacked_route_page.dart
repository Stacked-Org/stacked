...
abstract class StackedRoutePage extends Page {
  ...
  factory StackedRoutePage.adaptive() {
    return MaterialPageX(data: null, child: null);
  }

  @override
  bool canUpdate(Page other) {
    var canUpdate = other.runtimeType == runtimeType && (other as StackedRoutePage).data == this.data;
  ...
  Route createRoute(BuildContext context) {
    ...
    if (child is StackedRouterWrapper) {
      childToBuild = (child as StackedRouterWrapper).wrappedRoute(context);
    }
...
class MaterialPageX extends StackedRoutePage {
  MaterialPageX({
...
class CupertinoPageX extends StackedRoutePage {
  final String title;
...
class AdaptivePage extends StackedRoutePage {
...
class CustomPage extends StackedRoutePage {
  final bool opaque;
