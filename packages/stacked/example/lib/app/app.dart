...
import 'package:new_architecture/ui/logic_example/logic_view.dart';
...
@StackedApp(
  routes: [
    ...
    MaterialRoute(page: LogicView, initial: true),
  ],
  dependencies: [
    // Lazy singletons
    ...
    LazySingleton(classType: HumanService),
    LazySingleton(classType: CacheService),
    LazySingleton(classType: LogicRunner),
