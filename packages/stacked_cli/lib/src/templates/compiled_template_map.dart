    ...
    modificationFiles: [
      ModificationFile(
        ...
        modificationTemplate:
            '''import \'package:{{packageName}}/{{{dialogsPath}}}/{{dialogFolderName}}/{{dialogFilename}}.dart\';''',
        modificationProblemError:
            'It seems your file where custom dialog builders are set is not in lib/ui/setup/setup_dialog_ui.dart. Add a stacked.json file and set \'dialog_builder_file_path\' so we can locate your file.',
      ...
      ModificationFile(
        ...
        modificationTemplate:
            '''DialogType.{{dialogType}}: (context, request, completer) => {{dialogName}}(completer: completer, request: request),''',
        modificationProblemError:
            'It seems your file where custom dialog builders are set is not in lib/ui/setup/setup_dialog_ui.dart. Add a stacked.json file and set \'dialog_builder_file_path\' so we can locate your file.',
      ...
      ModificationFile(
        ...
        modificationProblemError:
            'It seems your file for DialogType class is not in lib/enums/dialog_type.dart. Add a stacked.json file and set the path for \'dialog_type_file_path\' to the folder so we can locate your DialogType class.',
  ...
  'bottom_sheet': StackedTemplate(
    ...
    modificationFiles: [
      ModificationFile(
        ...
        modificationIdentifier: '// @stacked-import',
        modificationTemplate:
            '''import \'package:{{packageName}}/{{{bottomSheetsPath}}}/{{sheetFolderName}}/{{sheetFilename}}.dart\';''',
        modificationProblemError:
            'It seems your file where custom bottom sheet builders are set is not in lib/ui/setup/setup_bottom_sheet_ui.dart. Add a stacked.json file and set \'bottom_sheet_custom_builders_path\' so we can locate your file.',
      ...
      ModificationFile(
        ...
        modificationProblemError:
            'It seems your file for BottomSheetType class is not in lib/enums/bottom_sheet_type.dart. Add a stacked.json file and set the path for \'bottom_sheet_type_enums\' to the folder so we can locate your BottomSheetType class.',
      ...
      ModificationFile(
        ...
        modificationTemplate:
            '''BottomSheetType.{{sheetType}}: (context, request, completer) => {{sheetName}}(completer: completer, request: request),''',
        modificationProblemError:
            'It seems your file where custom bottom sheet builders are set is not in lib/ui/setup/setup_bottom_sheet_ui.dart. Add a stacked.json file and set \'bottom_sheet_custom_builders_path\' so we can locate your file.',
